    ...
    <>
      <button
        ...
        style={{
          ...
          padding: '8px 14px',
          background: 'var(--c-tintDanger)', color: 'var(--c-tintDangerText)',
          border: '1.5px solid var(--c-tintDangerText)', borderRadius: 8,
          fontSize: 13, fontWeight: 700, cursor: 'pointer', fontFamily: FONT,
          transition: 'background .15s, color .15s',
          ...style,
        }}
        onMouseEnter={(e) => { e.currentTarget.style.background = '#A32D2D'; e.currentTarget.style.color = '#fff'; }}
        onMouseLeave={(e) => { e.currentTarget.style.background = 'var(--c-tintDanger)'; e.currentTarget.style.color = 'var(--c-tintDangerText)'; }}
      >
        <Trash2 size={14} />
        Delete {n} selected
      </button>
