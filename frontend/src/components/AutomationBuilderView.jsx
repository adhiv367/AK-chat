...
const C = {
  ...
  brand:"#34D399", brandBright:"#2DD4BF", brandDark:"#0F6E56", brandBg:"rgba(52,211,153,0.16)", brandTint:"rgba(52,211,153,0.08)",
  purple:"#A5B4FC", purpleBg:"rgba(129,140,248,0.16)", purpleDark:"#818CF8",
  red:"#F87171", redBg:"rgba(248,113,113,0.14)", redDark:"#EF4444",
  orange:"#FBBF24", orangeBg:"rgba(251,191,36,0.16)", orangeBorder:"rgba(251,191,36,0.35)", orangeText:"#FCD34D",
  amber:"#FBBF24", amberBg:"rgba(251,191,36,0.14)",
  blue:"#60A5FA", blueBg:"rgba(96,165,250,0.16)", blueBorder:"rgba(96,165,250,0.35)",
  navy:"#93C5FD", navyBg:"rgba(96,165,250,0.12)",
  teal:"#2DD4BF", tealBg:"rgba(45,212,191,0.14)",
  pink:"#F472B6", pinkBg:"rgba(244,114,182,0.14)",
  sb:"var(--c-sidebarBg)", sbItem:"var(--c-navMuted)", sbActive:"var(--c-navHover)", sbBorder:"var(--c-navBorder)",
};
...
const StatusPill = ({ status }) => {
  const m = {
    Live:{bg:C.brandBg,color:C.brandDark,dot:true}, Draft:{bg:"rgba(152,162,181,0.14)",color:C.text4,dot:true},
    ...
    Connected:{bg:C.brandBg,color:C.brandDark,dot:true}, "Not connected":{bg:"rgba(152,162,181,0.14)",color:C.text4,dot:true},
    draft:{bg:"rgba(152,162,181,0.14)",color:C.text4,dot:true}, active:{bg:C.brandBg,color:C.brandDark,dot:true},
    inactive:{bg:"rgba(152,162,181,0.14)",color:C.text4,dot:true},
    paused:{bg:C.orangeBg,color:C.orangeText,dot:true}, error:{bg:C.redBg,color:C.redDark,dot:true},
  }[status] || {bg:"rgba(152,162,181,0.14)",color:C.text4,dot:true};
...
const Btn = ({ kind="ghost", icon, children, onClick, style, size="md", title, ...rest }) => {
  ...
  const v = {
    ...
    ghost:  { background:"var(--c-cardBg)", color:C.text3, border:`1.5px solid ${C.inputBorder}` },
    soft:   { background:C.brandBg, color:C.brandDark, border:"1px solid transparent" },
    danger: { background:"var(--c-cardBg)", color:C.redDark, border:`1.5px solid ${C.redBg}` },
  }[kind];
...
const Toggle = ({ value, onChange, size="md" }) => {
  ...
  return <div onClick={() => onChange && onChange(!value)} style={{ width:w, height:h, borderRadius:99, background:value?C.brandBright:"var(--c-border)", position:"relative", cursor:"pointer", transition:"background .2s", flexShrink:0 }}>
...
const Input = ({ style, ...p }) => <input {...p} style={{ width:"100%", padding:"8px 11px", border:`1.5px solid ${C.inputBorder}`, borderRadius:8, fontSize:12, fontFamily:"'DM Sans'", outline:"none", background:"var(--c-cardBg)", color:C.text1, ...style }}/>;
const Textarea = ({ style, ...p }) => <textarea {...p} style={{ width:"100%", padding:"9px 11px", border:`1.5px solid ${C.inputBorder}`, borderRadius:8, fontSize:12, fontFamily:"'DM Sans'", outline:"none", background:"var(--c-cardBg)", color:C.text1, lineHeight:1.5, resize:"vertical", ...style }}/>;
...
const FormatTextarea = ({ value, onChange, style, ...p }) => {
  ...
  const TBtn = ({ marker, label, sx, title }) => (
    <button type="button" title={title}
      ...
      style={{ width:26, height:24, border:`1px solid ${C.inputBorder}`, borderRadius:6, background:"var(--c-cardBg)", color:C.text1, fontFamily:"'DM Sans'", fontSize:12, cursor:"pointer", display:"inline-flex", alignItems:"center", justifyContent:"center", ...sx }}>
      {label}
    </button>
  );
  const insertVar = (k) => {
  ...
  return (
    <div>
      ...
      <textarea ref={taRef} value={value || ""} onChange={onChange}
        style={{ width:"100%", padding:"9px 11px", border:`1.5px solid ${C.inputBorder}`, borderRadius:8, fontSize:12, fontFamily:"'DM Sans'", outline:"none", background:"var(--c-cardBg)", color:C.text1, lineHeight:1.5, resize:"vertical", ...style }}
        {...p}/>
    </div>
  );
};
const Select = ({ style, children, ...p }) => <select {...p} style={{ width:"100%", padding:"7px 9px", border:`1.5px solid ${C.inputBorder}`, borderRadius:8, fontSize:12, fontFamily:"'DM Sans'", outline:"none", background:"var(--c-cardBg)", color:C.text1, ...style }}>{children}</select>;
...
// Normalize a custom field name into a {{variable}} token key.
...
const VarPickerButton = ({ onInsert, style }) => {
  ...
  // Custom contact fields from AKChat (Admin Settings → Fields), as variable
  ...
  return (
    <span ref={wrapRef} style={{ position:"relative", display:"inline-flex", ...style }}>
      <button
        ...
        onClick={()=>setOpen(o=>!o)}
        style={{ height:24, padding:"0 8px", border:`1px solid ${C.inputBorder}`, borderRadius:6, background:"var(--c-cardBg)", color:C.text1, fontFamily:"'DM Mono'", fontSize:11, cursor:"pointer", display:"inline-flex", alignItems:"center", gap:3, fontWeight:700 }}>
        {"{x}"}
      </button>
      {open && (
        <div style={{ position:"absolute", top:28, right:0, zIndex:50, minWidth:240, maxHeight:320, overflowY:"auto", background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, borderRadius:8, boxShadow:C.shadowLg || "0 8px 24px rgba(0,0,0,.12)", fontFamily:"'DM Sans'" }}>
  ...
  return (
    <div style={{ display:"flex", alignItems:"stretch", gap:6 }}>
      <input ref={ref} value={value ?? ""} onChange={onChange}
        style={{ flex:1, padding:"8px 11px", border:`1.5px solid ${C.inputBorder}`, borderRadius:8, fontSize:12, fontFamily:"'DM Sans'", outline:"none", background:"var(--c-cardBg)", color:C.text1, ...style }}
        {...p}/>
  ...
  return (
    <div style={{ position:"relative" }}>
      ...
      <textarea ref={ref} value={value ?? ""} onChange={onChange}
        style={{ width:"100%", padding:"9px 38px 9px 11px", border:`1.5px solid ${C.inputBorder}`, borderRadius:8, fontSize:12, fontFamily:"'DM Sans'", outline:"none", background:"var(--c-cardBg)", color:C.text1, lineHeight:1.5, resize:"vertical", ...style }}
        {...p}/>
    </div>
  );
};
...
const Alert = ({ kind, children, style }) => {
  const m = {
    ...
    error:{bg:C.redBg,color:C.redDark,border:"rgba(248,113,113,0.35)",icon:IC.err(13)},
...
// Node-card palette — dark surfaces with a distinct saturated accent per node
// type (reusing the shared dark theme colors) instead of the old pale-pink
// light theme. `bg` is the card body, `color`/`accent` are used for icon +
// label text, both chosen for solid contrast against the dark card.
const NT = {
  trigger:  { bg:"var(--c-cardBg)", border:"rgba(45,212,191,0.35)",  color:"#2DD4BF", accent:"#2DD4BF", label:"TRIGGER",       icon:IC.zap },
  message:  { bg:"var(--c-cardBg)", border:"rgba(129,140,248,0.35)", color:"#A5B4FC", accent:"#818CF8", label:"MESSAGE",       icon:IC.msg },
  condition:{ bg:"var(--c-cardBg)", border:"rgba(251,191,36,0.35)",  color:"#FBBF24", accent:"#FBBF24", label:"CONDITION",     icon:IC.branch },
  action:   { bg:"var(--c-cardBg)", border:"rgba(96,165,250,0.35)",  color:"#60A5FA", accent:"#60A5FA", label:"ACTION",        icon:IC.tag },
  delay:    { bg:"var(--c-cardBg)", border:"rgba(251,191,36,0.35)",  color:"#FCD34D", accent:"#FBBF24", label:"DELAY",         icon:IC.clock },
  api:      { bg:"var(--c-cardBg)", border:"rgba(96,165,250,0.35)",  color:"#93C5FD", accent:"#60A5FA", label:"API",           icon:IC.api },
  handoff:  { bg:"var(--c-cardBg)", border:"rgba(244,114,182,0.35)", color:"#F472B6", accent:"#F472B6", label:"HUMAN HANDOFF", icon:IC.agent },
  ai:       { bg:"var(--c-cardBg)", border:"rgba(129,140,248,0.35)", color:"#A5B4FC", accent:"#818CF8", label:"AI",            icon:IC.ai },
  subflow:  { bg:"var(--c-cardBg)", border:"rgba(45,212,191,0.35)",  color:"#2DD4BF", accent:"#2DD4BF", label:"SUB-FLOW",      icon:IC.flow },
};
...
const FlowNode = ({ n, selected, onSelect, onStartDrag, onStartConnect, whatsappAccounts=[] }) => {
  ...
  return (
    <div
      ...
      style={{
        position:"absolute", left:n.x, top:n.y, width:NODE_W, minHeight:h, background:"var(--c-cardBg)",
        border: selected ? `2px solid ${SEL}` : `1px solid ${isDisabled ? "var(--c-borderDark)" : C.cardBorder}`,
        borderRadius:12,
    ...
    >
      {isDisabled && (
        <div style={{
          ...
          background:"var(--c-cardBg)", color:"var(--c-textSecondary)", border:`1px solid ${C.cardBorder}`,
      ...
      {n.type !== "trigger" && (
        <div
          ...
          style={{ position:"absolute", top:-9, left:"50%", transform:"translateX(-50%)", display:"flex", alignItems:"center", justifyContent:"center", width:30, height:16, borderRadius:"8px 8px 4px 4px", background:"var(--c-cardBg)", border:`1.5px solid ${t.accent}`, borderBottomWidth:0, color:t.accent, fontSize:11, fontWeight:700, lineHeight:1, boxShadow:"0 1px 3px rgba(0,0,0,.10)", zIndex:5, cursor:"crosshair", fontFamily:"'DM Sans'" }}
        >
      ...
      {outputHandlesOf(n).map(h => {
        ...
        return (
          <div key={h}
            ...
            data-handle-which={h}
            style={{ position:"absolute", ...sidePos, width:12, height:12, borderRadius:"50%", background:"var(--c-cardBg)", border:`2px solid ${C.cardBorder}`, zIndex:5, cursor:"crosshair" }}
            {...handleEvents}
          >
            {h !== "default" && (
              <span style={{ position:"absolute", ...labelPos, fontSize:8, fontWeight:700, color:C.muted, whiteSpace:"nowrap", fontFamily:"'DM Mono'", letterSpacing:".06em", maxWidth:72, overflow:"hidden", textOverflow:"ellipsis", textAlign:"center", background:"var(--c-cardBg)", padding:"0 3px", borderRadius:3, zIndex:6 }}>
                {labelText}
              </span>
            )}
          </div>
  ...
  return (
    <svg style={{ position:"absolute", top:0, left:0, width:"100%", height:"100%", overflow:"visible", pointerEvents:"none" }}>
      ...
      {edges.map((e,i)=>{
        ...
        const color = isCond ? (e.fromHandle==="yes"?"#34D399":"#F87171") : "var(--c-textMuted)";
        return <g key={i}>
...
const EdgePlus = ({ x, y, onClick, withConnector=false }) => (
  <div data-testid={withConnector ? "append-plus" : "edge-plus"} onClick={onClick} style={{ position:"absolute", left:x, top:y, transform:"translate(-50%,-50%)", zIndex:8, cursor:"pointer" }}>
    <div style={{ width:26, height:26, borderRadius:"50%", background:"var(--c-cardBg)", border:`1.5px solid ${C.red}`, color:C.red, display:"flex", alignItems:"center", justifyContent:"center", fontSize:16, fontWeight:700, boxShadow:"0 2px 6px rgba(0,0,0,.12)", transition:"all .15s", lineHeight:1 }}>
      {IC.plus(14)}
    </div>
    {withConnector && (
...
const NodeActions = ({ x, y, onDuplicate, onDelete }) => (
  <div style={{ position:"absolute", left:x, top:y, transform:"translate(-50%,-100%)", zIndex:10, display:"flex", gap:4 }}>
    <button onClick={(e)=>{e.stopPropagation(); onDuplicate();}} style={{ background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, borderRadius:7, width:28, height:28, display:"flex", alignItems:"center", justifyContent:"center", color:C.text3, cursor:"pointer", boxShadow:"0 2px 6px rgba(0,0,0,.08)" }}>{IC.copy(13)}</button>
    <button onClick={(e)=>{e.stopPropagation(); onDelete();}} style={{ background:"var(--c-cardBg)", border:`1px solid ${C.redBg}`, borderRadius:7, width:28, height:28, display:"flex", alignItems:"center", justifyContent:"center", color:C.red, cursor:"pointer", boxShadow:"0 2px 6px rgba(0,0,0,.08)" }}>{IC.trash(13)}</button>
  </div>
);
...
const NodePicker = ({ x, y, onPick, onClose, mode, groups = [] }) => {
  ...
  return (
    <div ref={pickerRef} onClick={(e) => e.stopPropagation()} style={{ position:"fixed", left:pos.x, top:pos.y, zIndex:70, background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, borderRadius:12, padding:6, boxShadow:"0 12px 36px rgba(0,0,0,.14)", width:220, maxHeight:"70vh", overflowY:"auto" }}>
      ...
      {visibleGroups.map(g => {
        ...
        return (
          <div key={g.title} style={{ marginBottom:4 }}>
            <div onClick={()=>setActiveG(prev => prev === g.title ? null : g.title)} style={{ display:"flex", alignItems:"center", gap:6, padding:"5px 8px", cursor:"pointer", borderRadius:6, transition:"background .12s" }} onMouseEnter={e=>e.currentTarget.style.background="var(--c-hover)"} onMouseLeave={e=>e.currentTarget.style.background="transparent"}>
...
const BlockLibrary = ({ onAddBlock }) => {
  ...
  const [q, setQ] = useState("");
  return (
    <aside style={{ width:236, borderRight:`1px solid ${C.cardBorder}`, background:"var(--c-surfaceAlt)", display:"flex", flexDirection:"column", flexShrink:0 }}>
              ...
              {isOpen && items.map(it => {
                ...
                return (
                  <button data-testid="block-library-item" key={it.name} title={`Click to add "${it.name}" to the canvas · ${it.desc}`}
                    ...
                    style={{ background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, borderRadius:8, padding:"7px 9px", margin:"3px 4px", cursor:"pointer", display:"flex", alignItems:"center", gap:8, transition:"all .12s", width:"calc(100% - 8px)", textAlign:"left", fontFamily:"'DM Sans'" }}>
...
const SettingsPanel = ({ node, nodes=[], edges=[], onUpdateNode=()=>{}, onDeleteNode=()=>{}, onDuplicateNode=()=>{}, onSaveAndClose=()=>{}, onToggleDisable=()=>{}, onDeleteButton=()=>{}, onSelectTemplate=()=>{}, templates=[], teamMembers=[], tags=[], contactFields=[], otherAutomations=[], whatsappAccounts=[], assignableUsers=[] }) => {
  ...
  if (!node) return (
    <aside style={{ width:344, borderLeft:`1px solid ${C.cardBorder}`, background:"var(--c-cardBg)", flexShrink:0, padding:24, display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", textAlign:"center", color:C.text5 }}>
  ...
  if (node.type === "message") {
      ...
      switch (dt) {
        ...
        case "location":
          return <>
            ...
            <Field label="Location name (optional)"><VarInput value={dd.name || ""} onChange={e=>setDirect({name:e.target.value})} placeholder="e.g. AKChat Team" style={{ padding:"6px 9px", fontSize:11 }}/></Field>
    ...
    content = (<>
      ...
      {mode === "template" ? (<>
        <div style={{ background:C.blueBg, border:`1px solid rgba(96,165,250,0.35)`, borderRadius:10, padding:"10px 12px", marginBottom:14, display:"flex", alignItems:"flex-start", gap:9 }}>
        ...
        {tpl ? (<>
          <div style={{ display:"flex", flexWrap:"wrap", gap:6, marginBottom:14 }}>
            ...
            <Badge label={tpl.status} bg={tpl.status==="Approved"||tpl.status==="APPROVED"?C.brandBg:"rgba(251,191,36,0.16)"} color={tpl.status==="Approved"||tpl.status==="APPROVED"?C.brandDark:"var(--c-amber)"} dot/>
            {templateButtons && (
              <Badge label={`${templateButtons.length} reply button${templateButtons.length===1?"":"s"}`} bg="rgba(251,191,36,0.14)" color="var(--c-amber)"/>
            )}
          </div>
          ...
          {templateButtons && templateButtons.length > 0 && (<>
            ...
            {templateButtons.map((b, i) => (
              <div key={i} style={{ background:C.sectionBg, border:`1px solid ${C.innerBorder}`, borderRadius:10, padding:"10px 11px", marginBottom:6, display:"flex", alignItems:"center", gap:9 }}>
                <div style={{ width:22, height:22, borderRadius:5, background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:11, fontFamily:"'DM Mono'", fontWeight:700, color:C.text3, flexShrink:0 }}>{i+1}</div>
        ...
        <div style={{ background:"rgba(251,191,36,0.14)", border:`1px solid rgba(251,191,36,0.4)`, borderRadius:10, padding:"10px 12px", marginBottom:14, display:"flex", alignItems:"flex-start", gap:9 }}>
          <span style={{ color:"var(--c-amber)", flexShrink:0, paddingTop:1 }}>{IC.warn(15)}</span>
          <div style={{ flex:1, fontSize:11, color:"var(--c-amber)", lineHeight:1.5 }}>
    ...
    content = (<>
      ...
      <div style={{ background:C.sectionBg, border:`1px solid ${C.innerBorder}`, borderRadius:10, padding:8, marginBottom:14 }}>
        {WA_CONDITION_PRESETS.map(p=>(
          <button key={p.label} onClick={()=>addPresetAsRule(p)} className="picker-item" style={{
            ...
            <span style={{ width:18, height:18, borderRadius:5, background:"var(--c-cardBg)", border:`1.2px solid ${C.cardBorder}`, display:"flex", alignItems:"center", justifyContent:"center", color:C.brand, flexShrink:0 }}>{IC.plus(11)}</span>
      ...
      {rules.length === 0 && (
        <div style={{ background:C.redBg, border:`1px solid rgba(248,113,113,0.35)`, borderRadius:10, padding:"11px 13px", marginBottom:8, display:"flex", alignItems:"center", gap:9 }}>
      ...
      <div style={{ background:C.sectionBg, border:`1px solid ${C.innerBorder}`, borderRadius:10, padding:11 }}>
        ...
        {rules.length > 0 && (
          <div style={{ background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, borderRadius:8, padding:"8px 10px" }}>
            {rules.map((r, i)=>(
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:8 }}>
        <div style={{
          background: matchedSteps.length ? C.brandBg : "var(--c-cardBg)",
        ...
        <div style={{
          background: notMatchedSteps.length ? "rgba(251,191,36,0.16)" : "var(--c-cardBg)",
          border: `1px solid ${notMatchedSteps.length ? "rgba(251,191,36,0.4)" : C.cardBorder}`,
          borderRadius:10, padding:10,
          opacity: notMatchedSteps.length ? 1 : 0.85,
        }}>
          <div style={{ fontSize:9, color:"var(--c-amber)", fontWeight:700, letterSpacing:".08em", textTransform:"uppercase", marginBottom:3 }}>Not matched</div>
          <div style={{ fontSize:11, color: notMatchedSteps.length ? "var(--c-amber)" : C.text5, fontWeight:600, lineHeight:1.4 }}>
            {branchSummary(notMatchedSteps)}
          </div>
          <div style={{ fontSize:9, color: notMatchedSteps.length ? "var(--c-amber)" : C.muted, opacity: notMatchedSteps.length ? 0.75 : 1, fontFamily:"'DM Mono'", marginTop:4 }}>
    ...
    content = (<>
      <div style={{ background:C.pinkBg, border:`1px solid rgba(244,114,182,0.35)`, borderRadius:10, padding:"11px 13px", marginBottom:14, display:"flex", alignItems:"flex-start", gap:9 }}>
      ...
      <div style={{ background:C.sectionBg, border:`1px solid ${C.innerBorder}`, borderRadius:10, padding:6, marginBottom:14, maxHeight:260, overflowY:"auto" }}>
        {teamMembers.map(m => {
          ...
          const dot = m.avail === "online" ? "var(--c-green)" : m.avail === "away" ? "var(--c-amber)" : "#9C9B92";
          return (
            <button key={m.id}
              onClick={()=>{
              ...
              <div style={{ position:"relative", width:28, height:28, flexShrink:0 }}>
                <div style={{ width:28, height:28, borderRadius:"50%", background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, display:"flex", alignItems:"center", justifyContent:"center", fontSize:11, fontWeight:700, color:C.text2, fontFamily:"'DM Sans'" }}>
                  {m.name.split(" ").map(p=>p[0]).join("").slice(0,2)}
                </div>
                <span style={{ position:"absolute", bottom:-1, right:-1, width:9, height:9, borderRadius:"50%", background:dot, border:"2px solid var(--c-cardBg)" }}/>
              </div>
              <div style={{ flex:1, minWidth:0 }}>
              ...
              <span style={{
                ...
                background: isSel ? C.brand : "var(--c-cardBg)",
        ...
        {[
          ...
          <div key={x.key} style={{ display:"flex", alignItems:"center", justifyContent:"space-between", padding:"7px 0", borderBottom:`1px solid ${C.rowDiv}`, opacity: x.disabled ? 0.55 : 1 }}>
            <div style={{ display:"flex", alignItems:"center", gap:7 }}>
              ...
              {x.disabled && (
                <span style={{ fontSize:8.5, fontWeight:700, padding:"2px 6px", borderRadius:99, background:"rgba(251,191,36,0.16)", color:"var(--c-amber)", letterSpacing:".08em", textTransform:"uppercase", border:"1px solid rgba(251,191,36,0.4)" }}>Coming soon</span>
              )}
            </div>
            {x.disabled
              ? <div style={{ width:32, height:18, borderRadius:99, background:"var(--c-borderDark)", position:"relative", flexShrink:0, cursor:"not-allowed" }}>
    ...
    const TRIGGER_EXPLAIN = {
      ...
      link: {
        icon: IC.link, color: C.blue, bg: C.blueBg, border: "rgba(96,165,250,0.35)",
        source: "wa", sourceLabel: "WhatsApp inbound message webhook",
      ...
      qr: {
        icon: IC.qr, color: "#A5B4FC", bg: "rgba(129,140,248,0.16)", border: "rgba(129,140,248,0.35)",
        source: "wa", sourceLabel: "WhatsApp inbound message webhook",
        title: "QR code scan",
        body: "Technically identical to a click-to-chat link — the QR encodes a wa.me URL with a pre-filled message that identifies the scan source. WhatsApp doesn't know it came from a QR; AK Chat identifies it using the pre-filled text."
      },
      newContact: {
        icon: IC.user, color: C.purpleDark, bg: C.purpleBg, border: "rgba(129,140,248,0.35)",
      ...
      anyMessage: {
        icon: IC.msg, color: C.blue, bg: C.blueBg, border: "rgba(96,165,250,0.35)",
        source: "wa", sourceLabel: "WhatsApp inbound message webhook",
      ...
      tagApplied: {
        icon: IC.tag, color: "var(--c-textSecondary)", bg: "rgba(152,162,181,0.14)", border: "var(--c-border)",
      ...
      webhook: {
        icon: IC.api, color: C.navy, bg: C.navyBg, border: "rgba(96,165,250,0.3)",
      ...
      apiEvent: {
        icon: IC.api, color: "#A5B4FC", bg: "rgba(129,140,248,0.16)", border: "rgba(129,140,248,0.35)",
      ...
      kindFields = (<>
        ...
        <Field label="QR code preview">
          <div style={{ background:C.sectionBg, border:`1px solid ${C.innerBorder}`, borderRadius:10, padding:14, textAlign:"center" }}>
            <div style={{ width:104, height:104, margin:"0 auto 8px", background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, borderRadius:6, padding:6, display:"flex", alignItems:"center", justifyContent:"center" }}>
        ...
        <div style={{ flex:1 }}>
          <div style={{ display:"flex", alignItems:"center", gap:6, marginBottom:3, flexWrap:"wrap" }}>
            ...
            <span style={{
              ...
              background: ex.source === "wa" ? "var(--c-green)" : "var(--c-amber)",
              color:"#fff",
        ...
        return (
          ...
          >
            {all.length === 0 ? (
              ...
              <div style={{ display:"flex", flexDirection:"column", gap:5, maxHeight:200, overflowY:"auto", border:`1px solid ${C.cardBorder}`, borderRadius:8, padding:6, background:"var(--c-cardBg)" }}>
                {all.map(acc => {
    ...
    const aiContext = node.aiContext !== undefined ? node.aiContext : "We are AKChat team , an Erode-based Whatsapp Automation agency.";
    ...
    content = (<>
      <div style={{ background:"rgba(251,191,36,0.16)", border:"1px solid rgba(251,191,36,0.4)", borderRadius:10, padding:"11px 13px", marginBottom:14, display:"flex", alignItems:"flex-start", gap:9 }}>
        <span style={{ color:"var(--c-amber)", flexShrink:0, paddingTop:1 }}>{IC.warn(15)}</span>
        <div style={{ flex:1 }}>
          <div style={{ fontSize:12, fontWeight:700, color:"var(--c-amber)", marginBottom:3 }}>Meta AI policy · January 2026</div>
          <div style={{ fontSize:11, color:C.text2, lineHeight:1.5 }}>
    ...
    content = (<>
        ...
        return (
          <div key={a.id} style={{ marginBottom:16 }}>
            <div style={{ display:"flex", alignItems:"center", gap:9, marginBottom:7 }}>
              <span style={{ color:"var(--c-amber)", display:"flex", flexShrink:0 }}>{kind.icon(17)}</span>
                    ...
                    {[
                      ...
                      <button
                        ...
                        style={{
                          ...
                          background: assignMode===opt.v ? C.brandBg : "var(--c-cardBg)",
                  ...
                  {assignMode === 'variable' ? (
                    <>
                      ...
                      <div style={{ fontSize:10, color:C.text5, fontWeight:500, lineHeight:1.4 }}>
                        The resolved value must be a numeric user id (akchat_users.id). If it's missing, disabled, or not an admin/BDA Sales user, the step fails.
                      </div>
                    </>
                  ) : (
                    <>
                        ...
                        {[
                          ...
                          <button
                            ...
                            style={{
                              ...
                              background: roleFilter===opt.v ? C.brandBg : "var(--c-cardBg)",
                ...
                {isSetKind && (<>
                  ...
                  {curField && (
                    <div style={{ display:"flex", alignItems:"center", gap:6, marginTop:5 }}>
                      <span style={{ fontSize:9, fontWeight:700, padding:"2px 6px", borderRadius:5, background: isNumeric ? "rgba(251,191,36,0.14)" : isEmail ? C.blueBg : isPhone ? C.purpleBg : isDate ? C.tealBg : C.sectionBg, color: isNumeric ? "var(--c-amber)" : isEmail ? C.blue : isPhone ? C.purpleDark : isDate ? C.teal : C.text4, fontFamily:"'DM Mono'", letterSpacing:".04em", textTransform:"uppercase" }}>
      ...
      <details style={{ marginTop:4 }}>
        <summary style={{
          ...
          color:"var(--c-amber)", fontSize:14, fontWeight:600,
          fontFamily:"'DM Sans'",
        ...
        <div style={{ background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, borderRadius:10, padding:6, marginTop:6, boxShadow:"0 6px 18px rgba(0,0,0,.08)", maxHeight:240, overflowY:"auto" }}>
          {ACTION_KINDS.map(k => (
            <button key={k.kind} onClick={()=>addAction(k.kind)} className="picker-item" style={{
              ...
              <span style={{ color:"var(--c-amber)", display:"flex", flexShrink:0 }}>{k.icon(15)}</span>
              <span>{k.kind}</span>
            </button>
          ))}
        </div>
    ...
    content = (<>
      <Field label="Sub-flow to run" hint="The selected automation will execute. Pause and resume options apply on return.">
        <div style={{ position:"relative" }}>
          ...
          <div style={{ border:`1.5px solid ${C.inputBorder}`, borderRadius:8, background:"var(--c-cardBg)", maxHeight:220, overflowY:"auto" }}>
      ...
      {wf && (
        <div style={{ background:C.sectionBg, border:`1px solid ${C.innerBorder}`, borderRadius:10, padding:"11px 13px", marginBottom:14 }}>
          ...
          <div style={{ display:"flex", gap:8, alignItems:"center", flexWrap:"wrap" }}>
            <Badge label={wf.status} bg={wf.status==="active"||wf.status==="Active"?C.brandBg:"rgba(251,191,36,0.16)"} color={wf.status==="active"||wf.status==="Active"?C.brandDark:"var(--c-amber)"} dot/>
  ...
  return (
    <aside style={{ width:344, borderLeft:`1px solid ${C.cardBorder}`, background:"var(--c-cardBg)", flexShrink:0, overflowY:"auto" }}>
      <div style={{
        padding:"15px 18px 13px",
        borderBottom:`1px solid ${isActionHeader ? "rgba(251,191,36,0.35)" : C.cardBorder}`,
        background: isActionHeader ? "rgba(251,191,36,0.14)" : "var(--c-cardBg)",
      }}>
        <div style={{ display:"flex", alignItems:"center", gap:9, marginBottom: isActionHeader ? 0 : 10 }}>
          <div style={{
            width:32, height:32, borderRadius:8,
            background: isActionHeader ? "rgba(251,191,36,0.10)" : t.bg,
            color: isActionHeader ? "var(--c-amber)" : t.color,
            display:"flex", alignItems:"center", justifyContent:"center",
            border:`1px solid ${isActionHeader ? "rgba(251,191,36,0.35)" : t.border}`,
            flexShrink:0,
          ...
          <div style={{ flex:1, minWidth:0 }}>
            ...
            <div style={{ display:"flex", alignItems:"center", gap:5 }}>
              {editingTitle ? (
                <input
                  ...
                  style={{
                    ...
                    fontWeight:700,
                    color: isActionHeader ? "var(--c-amber)" : C.text1,
                    fontFamily:"'DM Sans'", flex:1, minWidth:0,
                    border:`1px solid ${C.brandBright}`,
                    borderRadius:5,
                    outline:"none", background:"var(--c-cardBg)",
                    padding:"2px 6px",
                    margin:"-2px -6px",
                ...
                <div
                  ...
                  style={{
                    fontSize: isActionHeader ? 17 : 14,
                    fontWeight:700,
                    color: isActionHeader ? "var(--c-amber)" : ((node.title && node.title.trim()) || node.type === 'trigger' ? C.text1 : C.muted),
                    fontFamily:"'DM Sans'", flex:1, minWidth:0,
                    padding:"2px 0",
              ...
              <IconBtn
                ...
                style={{
                  color: editingTitle ? C.brand : (isActionHeader ? "var(--c-amber)" : C.text5),
...
const BuilderToolbar = ({ automationName, status, onBack, onSave, isDirty, saving, onToggleStatus, toggleBusy, onPreview, showPreview, activeTab, onTabChange, onUndo, onRedo, canUndo, canRedo, onZoomIn, onZoomOut, onFit, onAutoLayout }) => {
  ...
  return (
    <div style={{ background:"var(--c-cardBg)", borderBottom:`1px solid ${C.cardBorder}`, padding:"9px 16px", display:"flex", alignItems:"center", gap:10, flexShrink:0 }}>
          ...
          return (
            <button
              ...
              style={{
                ...
                fontFamily: "'DM Sans'",
                cursor: 'pointer',
                background: isActive ? 'var(--c-cardBg)' : 'transparent',
...
const PhonePreview = ({ onClose, nodes = [], edges = [], templates = [], teamMembers = [], otherAutomations = [] }) => {
  ...
  return (
    <div style={{ width:308, borderLeft:`1px solid ${C.cardBorder}`, background:"var(--c-surfaceAlt)", flexShrink:0, display:"flex", flexDirection:"column", minHeight:0 }}>
      ...
      <div style={{ flex:1, minHeight:0, overflow:"hidden", padding:"14px 14px 10px", display:"flex", flexDirection:"column", alignItems:"center" }}>
        <div style={{
          ...
          <div style={{ position:"absolute", left:0, top:84,  width:3, height:30, background:"linear-gradient(90deg,rgba(255,255,255,.06),rgba(255,255,255,.16))", borderRadius:"3px 0 0 3px" }}/>
          <div style={{ position:"absolute", left:0, top:130, width:3, height:48, background:"linear-gradient(90deg,rgba(255,255,255,.06),rgba(255,255,255,.16))", borderRadius:"3px 0 0 3px" }}/>
          <div style={{ position:"absolute", left:0, top:188, width:3, height:48, background:"linear-gradient(90deg,rgba(255,255,255,.06),rgba(255,255,255,.16))", borderRadius:"3px 0 0 3px" }}/>
          <div style={{ position:"absolute", right:0, top:130, width:3, height:64, background:"linear-gradient(270deg,rgba(255,255,255,.06),rgba(255,255,255,.16))", borderRadius:"0 3px 3px 0" }}/>
          <div style={{ position:"absolute", right:0, top:208, width:3, height:38, background:"linear-gradient(270deg,rgba(255,255,255,.06),rgba(255,255,255,.16))", borderRadius:"0 3px 3px 0" }}/>
            ...
            <div style={{ flex: 1, minHeight: 0, position: "relative", borderRadius: 46.5, overflow: "hidden", display: "flex", flexDirection: "column", background: "#075E54" }}>
              ...
              <div style={{ background:"#075E54", paddingTop:50, paddingBottom:8, paddingLeft:12, paddingRight:12, color:"#fff", fontFamily:"-apple-system, 'SF Pro Display', system-ui, sans-serif", flexShrink:0, position:"relative", zIndex:1 }}>
                <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                  ...
                  <div style={{ flex:1, minWidth:0 }}>
                    <div style={{ fontSize:13, fontWeight:600, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>akchat Automation</div>
...
const Canvas = ({
  ...
  return (
    ...
    >
      ...
      <div style={{ position:"absolute", top:14, left:"50%", transform:"translateX(-50%)", background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, borderRadius:99, padding:"6px 14px", display:"flex", alignItems:"center", gap:10, boxShadow:"0 2px 8px rgba(0,0,0,.05)", fontSize:11, color:C.text3, fontWeight:500, fontFamily:"'DM Sans'", whiteSpace:"nowrap" }}>
        <span>Tap a step to edit</span>
        <span style={{ width:1, height:12, background:C.cardBorder }}/>
        <span style={{ display:"inline-flex", alignItems:"center", gap:5 }}>
          <span style={{ width:16, height:16, borderRadius:"50%", background:"var(--c-cardBg)", border:`1.5px dashed ${C.text4}`, color:C.text4, fontSize:11, fontWeight:600, display:"inline-flex", alignItems:"center", justifyContent:"center", lineHeight:1 }}>+</span>
      ...
      <div style={{ position:"absolute", bottom:14, left:14, display:"flex", gap:6 }}>
        <button onClick={()=>setTransform({ x:30, y:30, scale:0.7 })} style={{ background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, borderRadius:10, padding:"6px 10px", display:"flex", alignItems:"center", gap:6, fontSize:11, fontFamily:"'DM Mono'", fontWeight:700, color:C.text2, cursor:"pointer", boxShadow:"0 2px 8px rgba(0,0,0,.04)" }}>{IC.fit(13)} Fit</button>
        <button onClick={onAutoLayout} style={{ background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, borderRadius:10, padding:"6px 10px", display:"flex", alignItems:"center", gap:6, fontSize:11, fontFamily:"'DM Mono'", fontWeight:700, color:C.text2, cursor:"pointer", boxShadow:"0 2px 8px rgba(0,0,0,.04)" }}>{IC.flow(13)} Auto layout</button>
      </div>
...
const MiniMap = ({ nodes, transform }) => {
  ...
  if (!nodes || !nodes.length) {
    return (
      <div style={{ position:"absolute", bottom:14, right:14, width:mw+16, background:"var(--c-cardBg)", border:`1px solid ${C.cardBorder}`, borderRadius:10, padding:8, boxShadow:"0 4px 14px rgba(0,0,0,.05)" }}>
    ...
    <div style={{ display:"flex", flexDirection:"column", height:"100%", background:C.pageBg, fontFamily:"'DM Sans', system-ui, sans-serif" }}>
      ...
      {confirmOpen && (
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,.35)", zIndex:80, display:"flex", alignItems:"center", justifyContent:"center" }} onClick={closeConfirm}>
          <div style={{ background:"var(--c-cardBg)", borderRadius:12, padding:"24px", width:360, boxShadow:"0 20px 50px rgba(0,0,0,.2)" }} onClick={e=>e.stopPropagation()}>
      ...
      {backConfirmOpen && (
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,.35)", zIndex:80, display:"flex", alignItems:"center", justifyContent:"center" }} onClick={()=>setBackConfirmOpen(false)}>
          <div style={{ background:"var(--c-cardBg)", borderRadius:12, padding:"24px", width:400, boxShadow:"0 20px 50px rgba(0,0,0,.2)" }} onClick={e=>e.stopPropagation()}>
      ...
      <style>{`
        ...
        .rename-input:focus {
          ...
          box-shadow: 0 0 0 3px rgba(52,211,153,0.16) !important;
        }
