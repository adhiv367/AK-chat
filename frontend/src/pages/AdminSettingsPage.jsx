          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 10 }}>
            ...
            <div style={{ borderTop: `1px solid ${C.border}`, paddingTop: 16, marginTop: 6 }}>
              <button onClick={handleDeleteClick} style={{
                width: 'fit-content', display: 'flex', alignItems: 'center', gap: 8,
                padding: '10px 18px', borderRadius: 8, border: '1.5px solid rgba(248,113,113,0.35)',
                background: 'var(--c-tintDanger)', cursor: 'pointer', fontFamily: FONT, fontSize: 13,
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: FONT, fontSize: 13 }}>
              ...
              <tbody>
                {filteredTags.map(tag => (
                  <tr key={tag.id} style={{ background: sel.isSelected(tag.id) ? 'var(--c-rowSelected)' : 'var(--c-cardBg)', borderBottom: `1px solid ${C.border}` }}>
            ...
            <table style={{ width: '100%', borderCollapse: 'collapse', fontFamily: FONT, fontSize: 13 }}>
              ...
              <tbody>
                {categories.map(cat => {
                  ...
                  return (
                    <tr key={cat.id} style={{ background: sel.isSelected(cat.id) ? 'var(--c-rowSelected)' : 'var(--c-cardBg)', borderBottom: `1px solid ${C.border}`, cursor: 'pointer' }}
                      onClick={() => onViewDetail(cat.id)}
                      onMouseEnter={e => { if (!sel.isSelected(cat.id)) e.currentTarget.style.background = 'var(--c-rowHover)'; }}
                  ...
                  <td style={tdStyle}>
                    {(() => {
                      ...
                      const styles = {
                        ...
                        invalid_token: { bg: 'var(--c-tintDanger)', fg: 'var(--c-tintDangerText)', label: 'Token expired' },
                        rate_limited: { bg: 'var(--c-tintWarn)', fg: 'var(--c-tintWarnText)', label: 'Rate limited' },
                        unknown_error: { bg: 'var(--c-tintDanger)', fg: 'var(--c-tintDangerText)', label: 'Error' },
...
function RoleBadge({ role }) {
  ...
  return (
    <span style={{
      ...
      background: isAdmin ? 'var(--c-tintInfo)' : 'var(--c-tintSuccess)',
      color: isAdmin ? 'var(--c-tintInfoText)' : 'var(--c-tintSuccessText)',
    }}>
...
function UsersTab({ currentUser }) {
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px 32px' }}>
        {error && <div style={{ padding: 12, background: 'var(--c-tintDanger)', color: 'var(--c-tintDangerText)', borderRadius: 8, marginBottom: 16, fontSize: 13 }}>{error}</div>}
        {loading ? (
                      ...
                      <td style={{ padding: '12px 16px' }}>
                        <button onClick={() => !isSelf && toggleActive(u)} disabled={isSelf}
                          ...
                          style={{
                            ...
                            background: u.isActive !== false ? 'var(--c-tintSuccess)' : 'var(--c-tintNeutral)',
    ...
    <div style={{ display: 'flex', flex: 1, height: '100%', overflow: 'hidden', background: C.pageBg }}>
      <div style={{
        ...
        <button
          ...
          onMouseEnter={e => { e.currentTarget.style.background = 'var(--c-rowHover)'; }}
          ...
          return (
            <button
              ...
              style={{
                ...
                background: isActive ? 'var(--c-rowSelected)' : 'transparent',
